# Doom source files - automatically find all .c files
DOOM_SRCS := $(wildcard src/doomgeneric/*.c)
# Convert to object file paths
DOOM_OBJS := $(patsubst src/doomgeneric/%.c,./build/doomgeneric/%.o,$(DOOM_SRCS))
...
FILES = ./build/kernel.asm.o ./build/kernel.o \
        ...
        ./build/string/string.o ./build/stdlib/stdlib.o ./build/stdio/stdio.o \
...
all: ./bin/boot.bin ./bin/kernel.bin
	...
	dd if=./bin/kernel.bin of=./bin/os.bin bs=512 seek=1
...
./build/stdio/stdio.o: ./src/stdio/stdio.c
	i686-elf-gcc $(INCLUDES) -I./src/stdio $(FLAGS) -std=gnu99 -c ./src/stdio/stdio.c -o ./build/stdio/stdio.o
...
./build/graphics/vga_palette.o: ./src/graphics/vga_palette.c
	@mkdir -p ./build/graphics
	i686-elf-gcc $(INCLUDES) -I./src/graphics $(FLAGS) -std=gnu99 -c ./src/graphics/vga_palette.c -o ./build/graphics/vga_palette.o
	
# Pattern rule for ALL Doom source files
./build/doomgeneric/%.o: ./src/doomgeneric/%.c
	@mkdir -p ./build/doomgeneric
	i686-elf-gcc $(INCLUDES) -I./src/doomgeneric $(FLAGS) -std=gnu99 -c $< -o $@
